...
fun main() {
    ...
    while (true) {
        ...
        when (choice) {
            ...
            "exit" -> {
                println("ออกจากโปรแกรม. ขอบคุณที่ใช้บริการ!")
...
fun convertCelsiusToFahrenheit() {
    ...
    val celsius = input.toDoubleOrNull() ?: run {
        println("อินพุตไม่ถูกต้อง. กรุณาป้อนตัวเลขสำหรับองศาเซลเซียส.")
        return
    }
...
fun convertKilometersToMiles() {
    ...
    val kilometers = input.toDoubleOrNull() ?: run {
        println("อินพุตไม่ถูกต้อง. กรุณาป้อนตัวเลขสำหรับกิโลเมตร.")
        return
    }
